...
export const CRTWrapper = ({ children }: { children: React.ReactNode }) => (
  <div className="min-h-screen bg-[#0a0a0a] text-[#00ff41] font-mono p-2 md:p-8 relative overflow-hidden selection:bg-[#00ff41] selection:text-black">
    ...
    <div className="max-w-4xl mx-auto border-4 border-[#00ff41] p-2 md:p-4 shadow-[0_0_25px_rgba(0,255,65,0.2)] bg-[#0d0d0d] relative z-10">{children}</div>
  </div>
);